...
RedTail = c(18,9,12,4,-1);
CarderBee = c(8,27,6,32,23);
HoneyBee = c(12,13,16,9,10);

BeeMatrix = rbind(BuffTail,GardenBee,RedTail,CarderBee,HoneyBee);

colnames(BeeMatrix) = c("Thisle","Vipers","Golden Rain","Yellowalfalfa","BlackBerry")
...
FinAns = list(BeeMatrix,colnames(BeeDataFrame))
